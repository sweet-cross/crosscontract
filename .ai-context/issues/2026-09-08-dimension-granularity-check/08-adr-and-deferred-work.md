...
## Acceptance Criteria
- [ ] `.ai-context/adrs/0009-fact-data-is-reported-at-one-granularity-per-group.md` exists,
      following the structure of the existing ADRs and cross-linked from ADR 0001.
- [ ] It records: the decision (within a group of otherwise-identical rows, the members
...
- [ ] It records **why the group is sound**: `ValueVariableSchema` requires every field
...
- [ ] An entry is appended to `.ai-context/TODO.md` for the deferred stored-rows half,
