...
- [ ] It records **why checks name mechanics rather than meanings** — `unique: bool` on field constraints means a primary key is one arity of a general rule, and the business meaning is a label supplied at derivation.
