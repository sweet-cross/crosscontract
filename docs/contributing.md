<!--
Keep this page in sync with /CONTRIBUTING.md at the repo root.
Both documents describe the same workflow; the root file is the canonical
source consulted by GitHub and most contributors, this one renders on the
docs site.
-->
...
See [.claude/CLAUDE.md](https://github.com/sweet-cross/crosscontract/blob/dev/.claude/CLAUDE.md) for the full command reference (uv, pytest, ruff, mypy, mkdocs).
